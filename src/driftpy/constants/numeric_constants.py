...
AMM_TIMES_PEG_TO_QUOTE_PRECISION_RATIO = AMM_RESERVE_PRECISION * PEG_PRECISION / QUOTE_PRECISION
QUOTE_TO_BASE_AMT_FUNDING_PRECISION = (AMM_RESERVE_PRECISION * FUNDING_RATE_PRECISION / QUOTE_PRECISION)
PRICE_TO_QUOTE_PRECISION_RATIO = PRICE_PRECISION / QUOTE_PRECISION  
PRICE_TIMES_AMM_TO_QUOTE_PRECISION_RATIO  = PRICE_PRECISION * AMM_TO_QUOTE_PRECISION_RATIO
LIQUIDATION_FEE_TO_MARGIN_PRECISION_RATIO = LIQUIDATION_FEE_PRECISION / MARGIN_PRECISION
FUNDING_RATE_TO_QUOTE_PRECISION_PRECISION_RATIO = FUNDING_RATE_PRECISION / QUOTE_PRECISION
FUNDING_RATE_PRECISION = PRICE_PRECISION * FUNDING_RATE_BUFFER  
