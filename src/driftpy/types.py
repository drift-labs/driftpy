...
class AMM:
    ...
    def __deepcopy__(self, memo):
        copied = AMM(
            self.oracle,
            deepcopy(self.historical_oracle_data, memo),
            self.base_asset_amount_per_lp,
            self.quote_asset_amount_per_lp,
            deepcopy(self.fee_pool, memo),
            self.base_asset_reserve,
            self.quote_asset_reserve,
            self.concentration_coef,
            ...
            self.base_asset_amount_short,
            self.base_asset_amount_with_amm,
            self.base_asset_amount_with_unsettled_lp,
            self.max_open_interest,
            self.quote_asset_amount,
            self.quote_entry_amount_long,
            self.quote_entry_amount_short,
            self.quote_break_even_amount_long,
            self.quote_break_even_amount_short,
            self.user_lp_shares,
            self.last_funding_rate,
            self.last_funding_rate_long,
            self.last_funding_rate_short,
            self.last24h_avg_funding_rate,
            self.total_fee,
            self.total_mm_fee,
            self.total_exchange_fee,
            self.total_fee_minus_distributions,
            self.total_fee_withdrawn,
            self.total_liquidation_fee,
            ...
            self.last_oracle_normalised_price,
            self.last_oracle_reserve_price_spread_pct,
            self.last_bid_price_twap,
            self.last_ask_price_twap,
            self.last_mark_price_twap,
            self.last_mark_price_twap5min,
            self.last_update_slot,
            self.last_oracle_conf_pct,
            self.net_revenue_since_last_funding,
            self.last_funding_rate_ts,
            self.funding_period,
            ...
            self.long_spread,
            self.short_spread,
            self.long_intensity_count,
            self.short_intensity_count,
            self.max_fill_reserve_fraction,
            self.max_slippage_ratio,
            self.curve_update_intensity,
            self.amm_jit_intensity,
            self.oracle_source,
            self.last_oracle_valid,
            self.target_base_asset_amount_per_lp,
            self.per_lp_base,
            self.total_fee_earned_per_lp,
            self.net_unsettled_funding_pnl,
            self.quote_asset_amount_with_unsettled_lp,
            self.reference_price_offset,
            self.taker_speed_bump_override,
            self.amm_spread_adjustment,
            self.amm_inventory_spread_adjustment,
            self.padding,
        )
        memo[id(self)] = copied
        return copied
